    ...
    <ion-content :fullscreen="true">
      ...
      <ion-grid class="custom-grille">
        <ion-row class="ion-justify-content-center">
          <ion-col size="auto">
            <ion-button @click="showEditForm">Changer de mot de passe</ion-button>
          </ion-col>
        </ion-row>
        <ion-row class="ion-justify-content-center">
          <ion-col size="auto">
...
<script lang="ts">
import { IonPage,IonGrid,IonCol,IonRow, IonHeader, IonToolbar, IonTitle, IonContent, IonButton } from '@ionic/vue';
